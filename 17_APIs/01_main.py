...
# print(random_user["data"]["data"][0]["location"]["country"])


# print(random_user["data"]["data"][0]["name"]["title"] + " " + random_user["data"]["data"][0]["name"]["first"] + " " + random_user["data"]["data"][0]["name"]["last"])

# print(f"Hi my name is {random_user["data"]["data"][0]["name"]["title"]}")